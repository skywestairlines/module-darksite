...
class DarkSite extends DataObject {
	...
	private static $defaults = array(
		...
		'showContacts'  => 1,
		'showResources' => 1,
		'PRPlace' 		=> 'Atlanta, GA',	// date(\"F j, Y g:i a T\")", <-- does not work, need to find out if I can get this to work somehow.
		//'MediaInq' 		=> '206.870.0406',
		'FamilyInq' 	=> 'ExpressJet has set up a toll free number for those who believe that a family member or friend may have been on board Flight #XXXX.',
	...
	public function getCMSFields() {
		...
		$f->addFieldToTab('Root.Briefing', $eventDate = new DateField('MediaDate', DBDate::class));
		...
		$f->addFieldToTab('Root.TwitterFeed', CheckboxField::create('ShowTweet')->setTitle('Show Recent Tweet on Dark Site'));
